...
export function OrderForm() {
  ...
  return (
    <div className="bg-[#0A0A0A] p-8 md:p-12 rounded-[20px] shadow-2xl border border-[#1A1A1A] space-y-10">
      <div className="text-center space-y-3">
        <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight uppercase">Order Details</h2>
