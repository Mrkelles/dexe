...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#F5B800] to-[#E09000] py-16 lg:py-24 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl lg:text-6xl font-black tracking-tight leading-[1.05] text-white">
                Turn Grey Hair Back to Natural Black in 5 Minutes!
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                className="h-14 px-10 rounded-full bg-white text-[#F0A500] text-lg font-bold hover:bg-white/90 shadow-heroPanel transition-all hover:scale-105"
              >
                GET MY PACK NOW
              </Button>
            </div>
            ...
            <div className="flex items-center gap-6 pt-4 border-t border-white/20">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map(i => (
                  <div key={i} className="h-10 w-10 rounded-full border-2 border-[#F0A500] bg-white/20 overflow-hidden relative">
                    <Image 
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative aspect-square max-w-xl mx-auto">
              ...
              <div className="absolute top-1/4 -left-4 z-20 bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                <p className="text-[10px] font-bold text-white uppercase tracking-wider">Original Dexe</p>
                <p className="text-sm font-black text-white">Lasts up to 30 Days!</p>
              </div>

              <div className="absolute bottom-1/4 -right-4 z-20 bg-white p-4 rounded-2xl shadow-heroPanel text-[#F0A500]">
                <p className="text-2xl font-black">₦18,500</p>
                <p className="text-xs text-[#9A9A9A] line-through font-bold">₦25,000</p>
              </div>
            </div>
          </div>
        </div>
